...
const Perfil: React.FC = () => {
  ...
  const resetarPreferencias = async() => {
      ...
      <IonRow id="lDesktop" className="pagPerfil">
        ...
        {view === 'perfil' && (
          <IonCol className="ladoConfig">
            <div id="infos"> 
              <h1 className="preto" id="h1Titulo">Configurações de perfil</h1> </div>
            <div id="flexColunas">
        ...
        {mobileView === 'seguranca' && (
          <IonRow id="confSeg">
            ...
            <IonRow className="paddingConf">
              ...
              />
              <IonInput
                className="inputBioSenhaMpDarkmode"
                label="Confirmar senha"
                labelPlacement="stacked"
                type="password"
                name="confirmar_senha"
              ...
              <div id="excSenhaM">
                <IonRow className="msmLinha"> 
                  <IonCheckbox checked={isChecked} onIonChange={handleCheckboxChange} id="check" /> <p className="excpM" id="boldExcM">Deseja excluir sua conta?</p> 
                </IonRow>
                <IonRow className="msmLinha"> 
                  <IonIcon icon={warning} className="iconesBio" /> 
                ...
                <IonRow> <IonButton className="btnConfigBio" disabled={!isChecked} onClick={handleDeleteClick}>Confirmar</IonButton>
               </IonRow>
              </div>
            </IonRow>
          </IonRow>
